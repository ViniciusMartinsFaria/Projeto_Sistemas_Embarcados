...
int main()
{
    ...
    // =========================================================
    // SEÇÃO 2: Hardware (Acelerador via PIO)
    // =========================================================
    ...
    // Loop principal: O x deve ser o centro do primeiro Sobel (Sobel 0)
        for(y = 1; y < HEIGHT - 1; y++) {
            ...
            for(x = 1; x < WIDTH - 2; x += 2) {
                ...
                // Se você SOUBER exatamente qual pixel P12, P13, P14 o Sobel está usando,
                // você deve inseri-lo aqui. Assumindo que eles são ignorados:
