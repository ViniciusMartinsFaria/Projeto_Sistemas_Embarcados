...
begin
    ...
    inv_sinal_0     <=  resize ( - signed(entrada(0,0)), 16 );          --[LINHA,COLUNA]
    inv_sinal_1     <=  resize ( - signed(entrada(2,0)), 16 );          --[LINHA,COLUNA]
    inv_sinal_shift <=  resize ( (- signed(entrada(1,0)) & '0'), 16 );  --[LINHA,COLUNA]
    shift           <=  resize ( (signed(entrada(1,2)) & '0'), 16 );    --[LINHA,COLUNA]     
    sinal_0         <=  resize (signed(entrada(0,2)), 16 );             --[LINHA,COLUNA]
    sinal_1         <=  resize (signed(entrada(2,2)), 16 );            --[LINHA,COLUNA]
