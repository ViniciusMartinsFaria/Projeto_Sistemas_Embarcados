...
architecture rtl of Intro is
    ...
    signal conn_entrada_4 : std_logic_vector(31 downto 0);
    ...
    signal fio_pixel_0 : std_logic_vector(7 downto 0);
    signal fio_pixel_1 : std_logic_vector(7 downto 0); 
    ...
    component MyFirstSOC is
        port (
            ...
            entrada_4_export : out std_logic_vector(31 downto 0);
            ...
            pixel_0_export   : in std_logic_vector(7 downto 0);
				pixel_1_export   : in std_logic_vector(7 downto 0)
        );
...
begin
    ...
    MySoC: MyFirstSOC port map (
        ...
        entrada_4_export => conn_entrada_4,
        
        dadoprt_export   => conn_dadoprt,  
        go_export        => conn_go,    
        resetproc_export => conn_resetproc, 
        
        pixel_0_export   => fio_pixel_0,
        pixel_1_export   => fio_pixel_1
    );
